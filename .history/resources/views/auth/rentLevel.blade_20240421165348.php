                        ...
                        <div class="col-md-8">
                            @if ($rentLevel)
                                <p class="fw-bold bd-highlight text-wrap bg-light text-success">Nivelul arendei a fost
                                    setat pentru acest an, nu mai puteți adăuga altă valoare decât anul următor. În
                                    schimb, puteți edita sau șterge nivelul arendei curent.</p>
                            @else
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <input type="number" class="form-control @error('rentLevel') is-invalid @enderror" id="numberInput" name="rentLevel"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number"
                                            class="form-control" id="an"
                                            name="an" value="{{ $date }}" readonly>
                                    </div>
                                    @error('rentLevel')
                            ...
                            @if ($rentLevel)
                                <table class="table mt-5 text-center table-box-shadow">
                                    <thead>
                                        <tr>
                                            <th>Nivel Arenda</th>
                                            <th>An</th>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="mb-3">
                                                                            <label for="nouaValoare"
                                                                                class="form-label">Actualizează nivel
                                                                                arendă</label>
                                                                            <input type="number" class="form-control"
                                                                                id="nouaValoare" name="valoareNoua">
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary"
