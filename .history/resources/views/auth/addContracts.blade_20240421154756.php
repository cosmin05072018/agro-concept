                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ old('data_incepere') }}" id="data_incepere" type="date"
                                            class="form-control" name="data_incepere" placeholder="dd-mm-yyyy">
                                    </div>
                                    <div class="col-md-6">
...
<script>
    $(document).ready(function() {
        // Modificarea atributului "value" la încărcarea paginii
        $('#data_incepere').val(""); // Înlătură valoarea implicită
        // Interceptarea și prelucrarea valorii la schimbarea câmpului
        $('#data_incepere').change(function() {
            var inputValue = $(this).val();
            var parts = inputValue.split("/");
            // Formatul nou al datei: yyyy-MM-dd
