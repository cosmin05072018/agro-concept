                        ...
                        <div class="col-md-8">
                            <form class="bg-white p-3 rounded table-box-shadow" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="suprafata_terenului" class="form-label">Suprafata terenului: <span class="text-danger fw-bold">*</span></label>
                                        <input value="{{ old('suprafata_terenului') }}" id="suprafata_terenului" type="text"
