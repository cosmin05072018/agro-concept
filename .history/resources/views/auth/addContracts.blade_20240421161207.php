                            ...
                            <form method="POST" action="{{ route('add-contract') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    {{-- <input value="{{ old('locul_terenului') }}" id="locul_terenului" type="text"
                                        ...
                                        <select class="form-control" id="teren" name="locul_terenului " name="locul_terenului"old={{ "locul_terenului" }}>
                                            <option selected disabled>Alege teren</option>
                                            @foreach ($terenuri as $teren)
                                                <option name="locul_terenului" value="{{ $teren->id }}" old={{ "locul_terenului" }}>{{ $teren->nume_teren }}</option>
                                            @endforeach
                                        </select>
                                </div>
