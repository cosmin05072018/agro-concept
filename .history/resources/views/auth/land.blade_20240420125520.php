                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="submit"
                                                                                class="btn btn-success" id="actualizeazaBtn">Actualizează</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
...
<script>
    $(document).ready(function() {
        $('input').not('#mentiuni').on('keyup input', function() {
            // Verifică dacă toate input-urile sunt completate
            var allInputsCompleted = true;
            $('input').not('#mentiuni').each(function() {
                if ($(this).val() === '') {
                    allInputsCompleted = false;
                    return false; // Ieși din buclă dacă un input nu este completat
                }
            });

            // Dezactivează sau activează butonul "Actualizează" în funcție de rezultat
            if (allInputsCompleted) {
                $('#actualizeazaBtn').prop('disabled', false);
            } else {
                $('#actualizeazaBtn').prop('disabled', true);
            }
        });
