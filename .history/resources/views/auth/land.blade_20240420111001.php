                                            ...
                                            <form method="POST" action="{{ route('addLand') }}" class="mb-5">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input id="nume" type="text" class="form-control"
                                                            name="nameLand" autofocus value="{{ old('nameLand') }}"
                                                            placeholder="Introduceti numele terenului">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="judet" class="form-label">Judet <span
                                                                class="text-danger fw-bold">*</span>:</label>
                                                        <input id="judet" type="text" class="form-control"
                                                            name="judet" value="{{ old('judet') }}"
                                                            placeholder="Introduceti numele judetului">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="localitate" class="form-label">Localitate <span
                                                                class="text-danger fw-bold">*</span>:</label>
                                                        <input id="localitate" type="text" class="form-control"
                                                ...
                                                <div class="mb-3">
                                                    <label for="mentiuni" class="form-label">Mențiuni
                                                        (opțional):</label>
