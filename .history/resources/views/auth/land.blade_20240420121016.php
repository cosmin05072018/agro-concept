                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-around align-items-center">
                                                            <button class="btn btn-warning w-25">
                                                                <a href="{{-- {{ route('updateProductView', $teren->id) }} --}}"
                                                                    class="text-white d-flex align-items-center justify-content-between">
                                                                    Actualizare teren
                                                                    <i class="bi bi-pass-fill"></i>
                                                                </a>
                                                            </button>
                                                            <form action="{{-- {{ route('deleteProduct', $teren->id) }}--}}"
                                                                method="POST">
                                                                @csrf
                                                                <button type="submit"
                                                                    class="btn btn-danger w-100 d-flex align-items-center justify-content-between">
                                                                    Delete <ion-icon name="reader-sharp"></ion-icon></button>
                                                            </form>
                                                        </div>
                                                    </td>
                                                </tr>
