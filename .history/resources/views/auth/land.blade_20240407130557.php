                            ...
                            <form method="POST" action="{{ route('addLand') }}">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input id="nume" type="text" class="form-control" name="nameLand" autofocus {{ old('nameLand') }}>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="suprafata" class="form-label">Suprafață teren:</label>
                                        <div class="d-flex align-items-center">
                                            <input id="suprafata" type="text" class="form-control" name="suprafata" {{ old('suprafata') }}> <span class="mx-1 fw-bold">/ha</span>
                                        </div>
                                    </div>
                                </div>
