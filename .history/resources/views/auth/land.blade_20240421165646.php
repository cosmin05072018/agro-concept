                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            ...
                            @endif
                            <form method="POST" action="{{ route('addLand') }}" class="mb-5 bg-white p-3 rounded-3 table-box-shadow">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input id="nume" type="text" class="form-control @error('nameLand') is-invalid @enderror" name="nameLand"
                                    ...
                                    <div class="col-md-4">
                                        <label for="judet" class="form-label">Judet <span
                                                class="text-danger fw-bold">*</span>:</label>
                                        <input id="judet" type="text" class="form-control @error('judet') is-invalid @enderror" name="judet"
                                    ...
                                    <div class="col-md-4">
                                        <label for="localitate" class="form-label">Localitate <span
                                                class="text-danger fw-bold">*</span>:</label>
                                        <input id="localitate" type="text" class="form-control @error('localitate') is-invalid @enderror" name="localitate"
