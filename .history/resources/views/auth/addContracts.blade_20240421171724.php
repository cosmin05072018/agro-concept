                            ...
                            <form class="bg-white p-3 rounded table-box-shadow" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control @error('suprafata_terenului') is-invalid @enderror"
                                            id="suprafata_terenului" name="suprafata_terenului">
                                            <option selected></option>
                                            @foreach ($terenuri as $teren)
                                                <option value="{{ $teren->nume_teren }}"
                                                    @if (old('suprafata_terenului') == $teren->nume_teren) selected @endif>
                                                    {{ $teren->nume_teren }}</option>
                                            @endforeach
                                        </select>
                                        @error('locul_terenului')
