                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="suprafata_terenului" class="form-label">Suprafata terenului: <span
                                                class="text-danger fw-bold">*</span></label>
                                        <input data-convert-comma value="{{ old('suprafata_terenului') }}" id="suprafata_terenului"
                                            type="text"
...
<script>
    $(document).ready(function() {
        ...
        // Preiau id-ul inputului
        var inputId = $(this).attr('id');

        // Preiau valoarea inputului și înlocuiesc virgulele cu puncte
        var value = $(this).val().replace(',', '.');

        // Setez noua valoare în input
        $(this).val(value);
    });
