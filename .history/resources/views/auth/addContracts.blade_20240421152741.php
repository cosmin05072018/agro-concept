                            ...
                            @endif
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ old('nume') }}" id="nume" type="text" class="form-control" name="nume" autofocus>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="prenume" class="form-label">Prenume:</label>
                                        <input value="{{ old('prenume') }}" id="prenume" type="text" class="form-control" name="prenume">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ old('data_incepere') }}" id="data_incepere" type="date" class="form-control" name="data_incepere">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="data_incheiere" class="form-label">Data încheierii contractului:</label>
                                        <input value="{{ old('data_incheiere') }}" id="data_incheiere" type="date" class="form-control" name="data_incheiere">
                                    </div>
                                </div>

                                <div class="mb-3">
                                    <label for="locul_terenului" class="form-label">Locul situării terenului:</label>
                                    <input value="{{ old('locul_terenului') }}" id="locul_terenului" type="text" class="form-control" name="locul_terenului">
                                </div>
