            ...
            <div class="bg-white p-3">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <form method="POST" action="{{ route(add-constract) }">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="nume" class="form-label">Nume:</label>
                                        <input id="nume" type="text" class="form-control" name="nume" autofocus>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input id="data_incepere" type="date" class="form-control" name="data_incepere">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="data_incheiere" class="form-label">Data încheierii contractului:</label>
                                        <input id="data_incheiere" type="date" class="form-control" name="data_incheiere">
                                    </div>
                                </div>

                                <div class="mb-3">
                                    <label for="locul_terenului" class="form-label">Locul situării terenului:</label>
                                    <input id="locul_terenului" type="text" class="form-control" name="locul_terenului">
                                </div>
