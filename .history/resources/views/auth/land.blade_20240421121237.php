                                ...
                                buttons: [{
                                    ...
                                    },
                                    {
                                        ...
                                        customize: function(doc) {
                                            ...
                                            //     margin: [0, 0, 0, 12],
                                            //     alignment: 'center',
                                            //     image: '{{ asset('storage/logo.png') }}' // Asigură-te că specifici extensia corectă a fișierului
                                            // });

                                            var logo = new Image();
                                            logo.src =
                                            '{{ asset('storage/logo.png') }}'; // Asigură-te că specifici extensia corectă a fișierului
