...
<script>
    $(document).ready(function() {
                                ...
                                exportOptions: {
                                    ...
                                    format: {
                                        body: function(inner, coldex, rowdex) {
                                            if (inner.length & lt; = 0) return inner;
                                            var el = $.parseHTML(inner);
                                            var result = '';
                                            $.each(el, function(index, item) {
                                                if (item.nodeName == '#text') result =
                                                    result + item.textContent;
                                                else if (item.nodeName == 'SUP') result =
                                                    result + item.outerHTML;
                                                else if (item.nodeName == 'STRONG') result =
                                                    result + item.outerHTML;
                                                else if (item.nodeName == 'IMG') result =
                                                    result + item.outerHTML;
        ...
        }); $(".dt-search").addClass("d-flex flex-column"); $(".dt-search-0").addClass("form-label"); $(
        ".dt-input").addClass("form-control form-control-sm mb-3"); $(".buttons-excel").addClass(
        "btn btn-primary"); $(".buttons-pdf").addClass("btn btn-danger"); $(".buttons-print").addClass(
        "btn btn-info");
