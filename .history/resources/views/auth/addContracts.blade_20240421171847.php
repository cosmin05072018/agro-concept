                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <form class="bg-white p-3 rounded table-box-shadow" method="POST"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="nume" class="form-label">Nume Proprietar:</label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="prenume" class="form-label">Prenume Proprietar:</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="suprafata_terenului" class="form-label">Suprafata terenului:</label>
                                        <input value="{{ old('suprafata_terenului') }}" id="suprafata_terenului" type="number"
                                            class="form-control @error('suprafata_terenului') is-invalid @enderror datepicker"
