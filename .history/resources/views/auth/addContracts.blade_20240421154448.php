...
<script>
   $(document).ready(function() {
    // Atribuie un eveniment de schimbare pentru câmpul de intrare
    $('#data_incepere').change(function() {
        // Obține valoarea introdusă în câmpul de intrare
        var inputValue = $(this).val();
        // Descompune data în zi, lună și an
        var parts = inputValue.split("-");
        // Formatul nou al datei: zi/lună/an
        var formattedDate = parts[2] + "/" + parts[1] + "/" + parts[0];
        // Setează valoarea formatată înapoi în câmpul de intrare
