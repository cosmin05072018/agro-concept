                                            ...
                                            @foreach ($terenuri as $teren)
                                                <tr>
                                                    ...
                                                    <td class="d-flex justify-content-around">
                                                        ...
                                                        @foreach ($terenuri as $teren)
                                                        <!-- Butonul de actualizare pentru fiecare teren -->
                                                        <button type="button" data-bs-toggle="modal" data-bs-target="#update{{ $teren->id }}">
                                                            <ion-icon class="updateIcon text-success" name="create-sharp"></ion-icon>
                                                        </button>

                                                        <!-- Modal de actualizare pentru fiecare teren -->
                                                        <div class="modal fade" id="update{{ $teren->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title text-success" id="exampleModalLabel">Actualizare</h5>
                                                                    ...
                                                                    <form action="#" method="POST">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input type="text" class="form-control" id="numeTeren" name="numeTeren" value="{{ $teren->nume_teren }}">
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="judet" class="form-label">Județ</label>
                                                                                <input type="text" class="form-control" id="judet" name="judet" value="{{ $teren->judet }}">
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="localitate" class="form-label">Localitate</label>
                                                                                <input type="text" class="form-control" id="localitate" name="localitate" value="{{ $teren->localitate }}">
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="mentiuni" class="form-label">Mențiuni</label>
                                                                                <input type="text" class="form-control" id="mentiuni" name="mentiuni" value="{{ $teren->mentiuni }}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Înapoi</button>
