                        ...
                        <div class="col-md-8">
                            <form method="POST" action="{{ route('add-contract') }}">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ old('nume') }}" id="nume" type="text"
                                            class="form-control @error('locul_terenului') is-invalid @enderror" name="nume" autofocus>
                                        @error('numef')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ old('prenume') }}" id="prenume" type="text"
                                            class="form-control @error('locul_terenului') is-invalid @enderror" name="prenume">
                                        @error('prenume')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ old('data_incepere') }}" id="data_incepere" type="text"
                                            class="form-control @error('locul_terenului') is-invalid @enderror datepicker" name="data_incepere">
                                        @error('data_incepere')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ old('data_incheiere') }}" id="data_incheiere" type="text"
                                            class="form-control @error('locul_terenului') is-invalid @enderror datepicker" name="data_incheiere">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="mentiuni" class="form-control @error('locul_terenului') is-invalid @enderror" name="mentiuni" rows="3"></textarea>
                                </div>
