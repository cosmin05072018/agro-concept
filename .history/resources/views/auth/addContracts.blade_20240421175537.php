                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ old('prenume') }}" id="prenume" type="text"
                                            class="form-control @error('prenume') is-invalid @enderror" name="prenume"
                                            placeholder="Introduceti Prenumele Proprietarului">
                                        @error('prenume')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="data_incepere" class="form-label">Data începerii
                                            contractului: <span class="text-danger fw-bold">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control @error('locul_terenului') is-invalid @enderror"
                                            ...
                                            <option selected disabled style="font-size: 12px"></option>
                                    ...
                                    <div class="col-md-6">
                                        <label for="suprafata_terenului" class="form-label">Suprafata terenului (/ha): <span
                                                class="text-danger fw-bold">*</span></label>
                                        <input data-decimal-only value="{{ old('suprafata_terenului') }}"
                                            id="suprafata_terenului" type="text"
...
<script>
    $(document).ready(function() {
        $('input[type="text"][data-decimal-only]').on('input', function() {
            var value = $(this).val();

            // Eliminăm orice caractere care nu sunt cifre sau punct
            value = value.replace(/[^\d.]/g, '');

            // Verificăm dacă valoarea este în formatul corect
            if (!/^\d+(\.\d{0,2})?$/.test(value)) {
                // Dacă nu este în formatul corect, eliminăm ultimul caracter introdus
                value = value.slice(0, -1);
            }

            // Actualizăm valoarea inputului
            $(this).val(value);
        });
