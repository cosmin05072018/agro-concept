                                                    ...
                                                    <div class="modal fade" id="update" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="{{ route('update-rent-level', [$productUpdate->id]) }}" method="POST" enctype="multipart/form-data" class="p-5 rounded">
                                                                    @method('PATCH')
                                                                <div class="modal-body">
                                                                    ...
                                                                </div>
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="button" class="btn btn-success">Actualizează</button>
                                                                </div>
                                                            </form>
                                                            </div>
                                                        </div>
